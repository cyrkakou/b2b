    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                ...
                <ul class="menu-nav">
                    <li class="menu-item menu-item-rel <?=service('menu')::active('dashboard')?>">
                        <a href="<?=base_url('/dashboard')?>" class="menu-link">
                            <span class="menu-text"><i class="fad fa-tachometer-alt mr-1"></i>Tableau de bord</span>
                        </a>
                    </li>
                </ul>
                <!--end::Header Nav-->
        ...
        <div class="topbar">
            ...
            <div class="topbar-item">
                <a href="<?=base_url('ressources/pharmacies/locator')?>" class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1" title="réseau de pharmacies">
                    <i class="fad fa-store text-primary"></i>
                </a>
            </div>
            <!--end::Cart-->
            <!--begin::Quick panel-->
