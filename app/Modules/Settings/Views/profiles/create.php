<!-- begin:Modal-->
<div id="modal_profile_create" class="modal right fade" data-backdrop="static" tabindex="-1" role="dialog"
     aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <!--begin::Form-->
            <form action="<?=base_url('settings/profiles/create'); ?>" class="validate" role="form"
                ...
                <div class="modal-body pb-0 min-w-350px">
                    <div class="form-group">
                        ...
                        <span class="form-text text-muted">Nom du profil</span>
                    </div>
                </div>
