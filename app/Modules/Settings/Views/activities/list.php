...
<div class="card card-custom bordered">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">
                Liste des secteurs d'activité - (<?= count(@$dataset) ?>)
            </h3>
        </div>
        
        <div class="card-toolbar">
            <a href="javascript:;" data-toggle="modal" data-target="#modal_activity_create" class="btn btn-light-primary font-weight-bolder">
