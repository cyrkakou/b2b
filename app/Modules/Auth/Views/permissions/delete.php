<!-- Modal-->
<div id="form_permission_delete" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form name="form" action="<?=base_url('auth/permissions/do_delete'); ?>"
                  method="POST"
                  role="form">
