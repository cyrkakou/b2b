<!-- Modal-->
<div id="form_permission_create" class="modal right fade" data-backdrop="static" tabindex="-1" permission="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <!--begin::Form-->
            <form action="<?=base_url('auth/permissions/do_create'); ?>" class="validate" role="form"
                  enctype="multipart/form-data" method="POST">
                <div class="modal-header">
                    <h5 class="modal-title mr-3"><?= lang('Layout.form_add_caption'); ?></h5>
                ...
                <div class="modal-body pb-0 min-w-350px">
                    <div class="">
                        <div class="form-group">
                            ...
                            <input name="permission_code" class="form-control alpha-code text-lowercase" type="text"
