<!-- Modal-->
<div id="form_component_update" class="modal right fade" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <!--begin::Form-->
            <form action="<?=base_url('auth/components/do_update'); ?>" class="validate" role="form"
                  enctype="multipart/form-data" method="POST">
                <div class="modal-header">
                    <h5 class="modal-title"><?= lang('Layout.form_update_caption'); ?></h5>
                ...
                <div class="modal-body pb-0 min-w-350px">
                    <input name="primary_key" type="hidden">
                    <div class="">
