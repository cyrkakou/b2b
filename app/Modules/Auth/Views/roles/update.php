<!-- Modal-->
<div id="form_role_update" class="modal right fade" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <!--begin::Form-->
            <form action="<?=base_url('auth/roles/do_update'); ?>" class="validate" role="form"
                  enctype="multipart/form-data" method="POST">
                <input name="role_id" type="hidden" />
                <div class="modal-header">
                    <h5 class="modal-title mr-2"><?= lang('Layout.form_update_caption'); ?></h5>
                ...
                <div class="modal-body pb-0 min-w-350px">
                    <div class="form-group">
                        ...
                        <input name="role_code" class="form-control form-control-solid alpha-code text-lowercase" type="text"
