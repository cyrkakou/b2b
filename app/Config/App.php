...
class App extends BaseConfig
{
    ...
    public $site = [
        ...
        'compagny'=>'Ibems Creative'    
    ];
    public $google_map_key = 'AIzaSyDbSHcfjumboXTYELqdhTLPimhQj1nFtmw';
/*


$config['X-Secret']       = 'KUKVtR2yPbtXfz0ho2xGDABPMETujuYov0tFzKIl';
