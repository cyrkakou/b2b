...
var KTWizard = function(elementId, options) {
    ...
    var Plugin = {
        ...
        updateUI: function() {
            ...
            KTUtil.hide(the.btnPrev,'flex');
            KTUtil.hide(the.btnSubmit,'flex');
            KTUtil.show(the.btnNext,'flex');

            if (Plugin.isLastStep()) {
                stepType = 'last';
                KTUtil.show(the.btnPrev,'flex');
                KTUtil.hide(the.btnNext,'flex');
                KTUtil.show(the.btnSubmit,'flex');
